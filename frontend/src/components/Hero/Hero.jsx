      ...
      <div className="h-full flex justify-center items-center p-4 bg-primary/10">
        <div className="container grid grid-cols-1 gap-4">
          ...
          >
            ...
            <button className="bg-blue-800 from-primary to-secondary text-white hover:scale-105 px-4 py-2 rounded-full duration-200 absolute -bottom-5 left-1/2 -translate-x-1/2 mt-5" style={{marginTop:"40px"}}>
              Search Now
            </button>
          </div>
        </div>
