import { LocationCityOutlined, Phone } from '@mui/icons-material'
import { Box, Card, CardActions, CardContent, CardMedia, Chip, Rating, Typography } from '@mui/material'
    ...
    <Box display="flex" justifyContent="space-between" my={2}>
        ...
        {place?.cuisine?.map(({ name }) => (
          ...
          <Typography gutterBottom variant="body2" color="textSecondary" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '10px',}}>
            <LocationCityOutlined /> {place.address}
          </Typography>
        )}
        {place.phone && (
